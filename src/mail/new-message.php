...
<?= Html::beginTag('p'); ?>
<?= \Yii::t('skeeks/reviews2', 'Review submitted successfully from the page'); ?>: <?= Html::a($model->page_url, $model->page_url); ?>
    <br/>
<?= \Yii::t('skeeks/reviews2', 'Date and time of sending'); ?>: <?= \Yii::$app->formatter->asDatetime($model->created_at) ?>
    <br/>
